...
class Game(object):
    ...
    def get_button_list(self):
        ...
        width = 140 # wielkosc przyciskoow
        height = 120
        # t_w: total width
        t_w = width * 2 + 50
    ...
    def division(self):
        ...
        dividend = divisor * random.randint(1,2)
    ...
    def display_frame(self,screen):
        ...
        if self.show_menu:
            ...
            msg_2 = " " #+ str(self.score)
            msg_1 = "Ilość punktów to: " + str(self.score)
...
class Button(object):
    def __init__(self,x,y,width,height,number):
        ...
        self.font = pygame.font.Font(None,60) #czcionka na przyciskach
